...
| 3 | Verification baseline | The repo lacked any dedicated automated test workflow for focused editor logic. | 2026-03-29 | Added Vitest-based unit tests for deterministic SpriteMode helpers and documented `npm run test` as part of the standard verification chain. | `docs/TESTING.md`, `src/modes/SpriteMode/*.test.ts` |
